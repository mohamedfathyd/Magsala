...
public class My_current_order extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_recervations_ recyclerAdapter_secondry;
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_order>> call = apiinterface.get_all_cuurent(id);
        call.enqueue(new Callback<List<contact_order>>() {
            ...
            public void onResponse(Call<List<contact_order>> call, Response<List<contact_order>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_recervations_(My_current_order.this, contactList);
