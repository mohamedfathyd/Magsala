...
import com.khalej.magsala.Adapter.RecyclerAdapter_recervations_;
import com.khalej.magsala.Adapter.RecyclerAdapter_recervations_a;
...
public class My_oldorder extends AppCompatActivity {
    Toolbar toolbar;
    ProgressBar progressBar;
    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private RecyclerAdapter_recervations_a recyclerAdapter_secondry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_oldorder);
    ...
    public void fetchInfo() {
        ...
        Call<List<contact_order>> call = apiinterface.get_all_old(id);
        call.enqueue(new Callback<List<contact_order>>() {
            ...
            public void onResponse(Call<List<contact_order>> call, Response<List<contact_order>> response) {
                ...
                recyclerAdapter_secondry = new RecyclerAdapter_recervations_a(My_oldorder.this, contactList);
